...
export default function MailDetailPage() {
  ...
  return (
    <div className={"mailDetail-container"}>
      <h1 className={"mailDetail-title"}>📨 정기 발송 메일 수정</h1>
      ...
      <div className={"mailDetail-card"}>
        <div className={"mailDetail-btn-wrapper"}>
          ...
          <button className={"mailDetail-updateBtn"} onClick={() => {
            location.href = `/component/mail/update/${mailDetail.mailIdx ? `mailIdx=${mailDetail.mailIdx}` : `scheduleIdx=${mailDetail.scheduleIdx}`}`;
          }}>정기 메일 수정</button>
        </div>
