          ...
          <div className="chat_chatList">
            ...
            <ul className="chat_roomList">
              {chatRoomList.length === 0 ? (
                <li className="chat_noResult">채팅방이 없습니다.</li>
              ) : (
                <>
                    ...
                    return (
                      ...
                      >
                        <div className={`chat_roomItemInner`}>
                          <div className="chat_roomName">{room.participants.find(parti => parti.memberId !== memberId)?.memberName || '대화중인 상대가 나갔습니다.'}</div>
              ...
              <>
                ...
                <div className="chat_chatHeader">
                  <div className="chat_userInfo">
                    <span className="chat_chatName">{currentRoom.participants.find(parti => parti.memberId !== memberId)?.memberName || '대화중인 상대가 나갔습니다.'}</span>
                  ...
                  <div className={currentRoom.participants.find(parti => parti.memberId !== memberId) ? "chat_chatActions" : "hidden"}>
                ...
                <div className="chat_chatInput">
                  {!currentRoom.participants.find(parti => parti.memberId !== memberId) ||
